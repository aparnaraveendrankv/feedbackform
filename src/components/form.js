...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'How easy was it to navigate our website?', 
        'qob': 'Were you able to find the information you were looking for?',
        'roc': 'How would you rate the overall design and layout of the website?',
        'exp': 'Was the website loading speed satisfactory?'
    };
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Form.Control type="text" required placeholder="E.g. Name" value={nm_value} onChange={e => setNmValue(e.target.value)} />
